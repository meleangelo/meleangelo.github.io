...
## Revisions
* [Approximate Variational Estimation for a Model of Network Formation](files/MeleZhuMarch2019.pdf), November 2019, Conditionally accepted, *Review of Economics and Statistics* (with [Lingjiong Zhu](http://www.math.fsu.edu/People/faculty.php?id=1472) )
...
* [A Structural Model of Homophily and Clustering in Social Networks](files/homophily_dec2019_revisionJBES.pdf), May2020, resubmitted to *Journal of Business and Economic Statistics*
     + Old versions: [Dec 2018](files/homophily_dec2018.pdf) [Sept 2017](files/homophily_sept2017.pdf)


* [A model of inter-organizational network formation](files/firmnetworks_ergm_dec2018), December 2018, Reject  and Resubmit from *Organization Science* (with [Shweta Gaonkar](http://shwetagaonkar.com)), *new version coming soon*
...
* Creativity and Market Success: Evidence from the movie industry (Jan 2018) (with Sharon Kim and [Shweta Gaonkar](http://shwetagaonkar.com)), *new version coming soon*
...
* Business card networks (with Juan Nelson Martinez Dahbura and Takanori Nishida)

* Model-based subsequent inference in stochastic blockmodel graphs with vertex covariates via spectral methods  (with Cong Mu, Avanti Athreya, Joshua Cape, Lingxin Hao and Carey Priebe)

* Latent Communities in Employment Relation and Wage Distribution: A Network Approach (with Lingxin Hao, Avanti Athreya, Joshua Cape, Cong Mu and Carey Priebe)
